...
class IntegrationUSEConfigFlow(ConfigFlow, domain=DOMAIN):
    ...
    def async_get_options_flow(config_entry: ConfigEntry):
        ...
        return IntegrationUSEOptionsFlow(config_entry)
    ...
    async def async_step_user(self, user_input: dict | None = None) -> FlowResult:
        ...
        return self.async_create_entry(
            title="config USE", data=self._user_inputs
        )


class IntegrationUSEOptionsFlow(OptionsFlow):
